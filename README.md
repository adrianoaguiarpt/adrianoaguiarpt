...
<h3 align="center">Full Stack Developer | Back-end Focus | Porto, Portugal 🇵🇹</h3>
...
Olá! Sou **Adriano Aguiar**, desenvolvedor full stack em formação, atualmente vivendo no **Porto, Portugal** 🇵🇹

Minha filosofia de estudo é clara: **entender o projeto do começo ao fim** – desde a estrutura HTML até as regras de negócio no back-end. Por isso, estou construindo uma base sólida em todas as camadas do desenvolvimento.

🎯 **Foco principal:** Back-end, bancos de dados e arquitetura de APIs

🌱 **O que estou estudando atualmente:**
- Aprofundando em **Node.js + TypeScript + Prisma**
- **Python** e **Java** para expandir horizontes no back-end
- **Docker** para containerização e ambientes profissionalizantes
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Flexbox-1A73E8?style=for-the-badge&logo=css3&logoColor=white" />
  <img src="https://img.shields.io/badge/Grid-FF4785?style=for-the-badge&logo=css3&logoColor=white" />
</p>
...
graph TD
    ...
    style G fill:#339933,stroke:#333,stroke-width:2px
    style K fill:#ED8B00,stroke:#333,stroke-width:2px
    style O fill:#2496ED,stroke:#333,stroke-width:2px
